      ...
      <div className="flex items-end gap-4">
        {[35, 60, 40, 70, 50, 55].map((h, i) => (
          <div key={i} className="flex flex-1 items-end gap-1">
            <div className="relative flex-1 overflow-hidden rounded-t-md bg-blue-100/60 dark:bg-blue-900/30" style={{ height: `${h}%` }}>
            ...
            <div className="relative flex-1 overflow-hidden rounded-t-md bg-slate-100 dark:bg-slate-800" style={{ height: `${h * 0.7}%` }}>
              <div className="absolute inset-0 -translate-x-full animate-[shimmer_1.5s_ease-in-out_infinite] bg-gradient-to-r from-transparent via-white/60 to-transparent dark:via-slate-700/60" />
            </div>
          </div>
        ))}
